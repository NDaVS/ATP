...
//
////                    List<RoadStation> roadStationList = trip.getRoad().getGroup().getStations();
//                    routeDTO.setTime_finish(String.valueOf(roadStationList.get(roadStationList.size() - 1).getTime()));
//
//                    List<String> stations = roadStationList.stream()
