...
public class TripService {
    ...
    public TripService(TripStationRepository tripRepository, StationRepository stationRepository, BusRepository busRepository, DriverRepository driverRepository) {
